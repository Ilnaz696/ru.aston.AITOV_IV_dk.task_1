...
26. Портировка выбором, сложность, что по памяти
27. Портировка вставкой, сложность, что по памяти
...
33. акие структуры данных вы знаете
...
110. Команды git init, что создается. Как скопировать удаленную репу?
...
117. Возможен git pull, если в файле в рабочем каталоге есть незафиксированные изменения?
